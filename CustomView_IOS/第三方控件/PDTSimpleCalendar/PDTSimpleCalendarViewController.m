...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    if (kind == UICollectionElementKindSectionHeader) {
        ...
        headerView.titleLabel.text = [self changeOverlayViewTextWithMonth:[[[self.headerDateFormatter stringFromDate:[self firstOfMonthForSection:indexPath.section]] componentsSeparatedByString:@" "] firstObject] andyear:[[[self.headerDateFormatter stringFromDate:[self firstOfMonthForSection:indexPath.section]] componentsSeparatedByString:@" "] lastObject]];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    self.overlayView.text = [self changeOverlayViewTextWithMonth:[[[self.headerDateFormatter stringFromDate:[self firstOfMonthForSection:firstIndexPath.section]] componentsSeparatedByString:@" "] firstObject] andyear:[[[self.headerDateFormatter stringFromDate:[self firstOfMonthForSection:firstIndexPath.section]] componentsSeparatedByString:@" "] lastObject]];
}

- (NSString *)changeOverlayViewTextWithMonth:(NSString *)month andyear:(NSString *)year {
    ...
    return [NSString stringWithFormat:@"%@ %@",string,year];
}
...
#pragma mark - init navigation custom titleView
- (void)setupNav {
