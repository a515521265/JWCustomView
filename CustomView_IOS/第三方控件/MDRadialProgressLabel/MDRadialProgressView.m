				   ...
				   inContext:(CGContextRef)context
{
	...
	if (! self.theme.sliceDividerHidden && self.theme.sliceDividerThickness > 0) {
        ...
        for (NSInteger i =0; i < self.progressTotal; i++) {
...
{
	NSInteger outerDiameter = MIN(viewSize.width, viewSize.height);
    double outerRadius = outerDiameter / 2.0 - self.internalPadding;
    NSInteger innerDiameter = (outerDiameter - self.theme.thickness);
    double innerRadius = innerDiameter / 2.0;
	NSInteger sliceCount = (NSInteger)self.progressTotal;
...
{
	NSInteger innerDiameter = MIN(viewSize.width, viewSize.height) - self.theme.thickness;
    double innerRadius = innerDiameter / 2.0;
