...
- (void)viewDidLoad {
    ...
    self.demoList = @[
                      ...
                      [DemoModel itemWithDcit:@{@"title":@"TextTabViewController",@"demoDescribe":@"仿饿了么关联选择列表",@"className":@"TextTabViewController"}],
                      [DemoModel itemWithDcit:@{@"title":@"QQTextViewController",@"demoDescribe":@"QQ好友伸缩列表",@"className":@"QQTextViewController"}],
                      [DemoModel itemWithDcit:@{@"title":@"TabViewLayoutTextViewController",@"demoDescribe":@"测试tabview实现9宫格图片",@"className":@"TabViewLayoutTextViewController"}],
