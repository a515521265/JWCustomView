...
//  CustomView_IOS
//
//  Created by 恒善信诚科技有限公司 on 17/3/21.
//
//
...
//    userInfoLayout.padding = UIEdgeInsetsMake(5, 5, 5, 5);
    ...
    userNameLabel.myCenterXOffset = 0 ;
    ...
    nickNameLabel.myCenterXOffset = 0 ;
...
//    ageLayout.padding = UIEdgeInsetsMake(5, 5, 5, 5);
    ...
    ageSelectLayout.myBottomMargin = 5;
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        UILabel * lab = [ageSelectLayout viewWithTag:1002];
        lab.hidden = true;
