defineClass('JSPatchDemoViewController',['scrollView','nametextf','passwordtextf','nextBtn'], {
            ...
            require('AVCaptureDevice,JWAlertView');
//            var alert = JWAlertView.alloc().initJWAlertViewWithTitle_message_delegate_cancelButtonTitle_otherButtonTitles("温馨提示", "当前相机不可使用", self, "知道了", null);
//            alert.alertShow();
